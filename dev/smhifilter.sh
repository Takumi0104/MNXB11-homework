...
FILTER_FILTERNAME_from1960to2020="from1960to2020_$FILTER_FILTEREDFILENAME"
log "Filtering on only the data from 1960 to 2020, writing to $FILTER_FILTERNAME_from1960to2020"


#not cool answer but actually work...
#tail -n 159013 $CLEANER_BAREDATAFILENAME | head -n 158255 > $FILTER_FILTERNAME_from1960to2020
...
STARTLINE=$(grep -n '1960\-01\-01 06:00:00' $CLEANER_BAREDATAFILENAME|cut -d':' -f 1) #good working
ENDLINE=$(grep -n '2020\-12\-31 15:00:00' $CLEANER_BAREDATAFILENAME|cut -d ':' -f 1) #good working
