...
STARTLINE=$(grep -n '1960-01-01' $CLEANER_BAREDATAFILENAME)
#ENDLINE=$(grep -n `2020\-12\-31`$CLEANER_BAREDATAFILENAME)

tail -n +$STARTLINE $CLEANER_BAREDATAFILENAME > $FILTER_FILTERNAME_from1960to2020
